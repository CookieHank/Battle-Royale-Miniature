...
class Player extends AcGameObject {
    ...
    update(){
        ...
        this.render(); // must build the element everytime or it will dispear
...
class AcGamePlayground {
    constructor(root) {
        ...
        this.players = [];
        this.players.push(new Player(this, this.width /2, this.height / 2, this.height /2 * 0.05, "white", this.height * 0.15, true));
